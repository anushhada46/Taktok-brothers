    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="footer-section">
          ...
          <ul class="info-footer">
            <li><a href="javascript:">Himlung</a></li>
            <li><a href="javascript:">Everest</a></li>
            <li><a href="javascript:">Manaslu</a></li>
            <li><a href="javascript:">Mera Peak</a></li>
            <li><a href="javascript:">Annapurna</a></li>
            <li><a href="javascript:">Lhotse</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="copyright">
      <div class="row copy-row">
        <div class="col-lg-6 col-md-6">
          <div class="copy-text">
            <p>Copyright © 2022, <a href="index.php">Taktok Brothers Expedition</a> | All Rights
              Reserved</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-6">
          <div class="copy-text">
            <p class="text-right">Design & Developed By <a href="index.php">Tech Guyz</a></p>
          </div>
        </div>
      </div>
    </div>
