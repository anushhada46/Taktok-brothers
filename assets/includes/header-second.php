...
<head>
    ...
    <link rel="stylesheet" href="assets/css/service-single.css">
                    ...
                    <ul class="nav-links">
                        ...
                        <li>
                            ...
                            <div class="mega-box">
                                <div class="content">
                                    <div class="row-25">
                                        <h4 class="no-mobile">Expeditions</h4>
                                        <ul class="nav nav-pills flex-column mega-links">
                                            <li class="nav-item">
                                                <a class="nav-link active port-inner-link" data-toggle="pill"
                        ...
                        <li><a href="blogs.php" class="hvr-underline-from-center">Blogs</a></li>
